	...
	return (
		<Routes>
			<Route path="/" element={<NavBar />}>
				...
				<Route path='leads' element={<Leads setEditData={setEditData} />} />
				<Route path='leads/create' element={<CreateLead addNewItem={addNewItem} editData={editData} />} />
				<Route path="contacts" element={<Contacts setEditData={setEditData} />} />
				<Route path='contacts/create' element={<CreateContact addNewItem={addNewItem} editData={editData} />} />
				<Route path="accounts" element={<Accounts setEditData={setEditData} />} />
